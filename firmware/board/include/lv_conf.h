/* Board configuration (ESP32-S3, ESP-IDF): same as ../../sim/lv_conf.h except FreeRTOS
 * instead of the Windows driver, 60 Hz refresh and two extra Montserrat sizes for the test screen. */
/**
 * @file lv_conf.h
